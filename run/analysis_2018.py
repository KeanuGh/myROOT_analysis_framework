...
def run_analysis() -> Analysis:
    ...
    return Analysis(
        ...
        # regen_metadata=True,
        # output_dir="/eos/home-k/kghorban/framework_outputs/analysis_2018",
        ttree=NOMINAL_NAME,
        analysis_label="analysis_2018",
        log_level=10,
        log_out="both",
...
if __name__ == "__main__":
    ...
    for wp in wps:
        ...
        def full_bkg(variable: str, wp_name: str, t: str | None = None) -> Histogram1D:
            ...
            if t:
                h += Histogram1D(th1=analysis.get_hist(f"{wp_name}_{variable}_fakes_bkg_{t}_src"))
            return h
