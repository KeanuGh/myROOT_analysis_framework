"""Run the original shadow-bin scaling unfolding.

This is the thesis-style implementation: unfold with the nominal response matrix,
then apply the shadow-bin acceptance ratio as a post-unfolding scale factor. It
does not use the shadow-bin response matrices directly.
"""
