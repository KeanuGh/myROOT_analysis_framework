...
datasets = {
    "wtaunu_l_dta_cvetobveto": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_L_maxHTpTV2_CVetoBVeto*_histograms.root/*.root",
        "TTree_name": ["T_s1tmv_NOMINAL", "T_s1tev_NOMINAL"],
        "label": r"C Veto B Veto",
    },
    "wtaunu_l_dta_cfilterbveto": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_L_maxHTpTV2_CFilterBVeto*_histograms.root/*.root",
        "TTree_name": ["T_s1tmv_NOMINAL", "T_s1tev_NOMINAL"],
        "label": r"C Filter B Veto",
    },
    "wtaunu_l_dta_bfilter": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_L_maxHTpTV2_BFilter*_histograms.root/*.root",
        "TTree_name": ["T_s1tmv_NOMINAL", "T_s1tev_NOMINAL"],
        "label": r"B Filter",
    },
    "wtaunu_h_dta_cvetobveto": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_H_maxHTpTV2_CVetoBVeto*_histograms.root/*.root",
        "TTree_name": "T_s1thv_NOMINAL",
        "label": r"C Veto B Veto",
    },
    "wtaunu_h_dta_cfilterbveto": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_H_maxHTpTV2_CFilterBVeto*_histograms.root/*.root",
        "TTree_name": "T_s1thv_NOMINAL",
        "label": r"C Filter B Veto",
    },
    "wtaunu_h_dta_bfilter": {
        "data_path": DTA_PATH
        + "user.kghorban.Sh_2211_Wtaunu_H_maxHTpTV2_BFilter*_histograms.root/*.root",
        "TTree_name": "T_s1thv_NOMINAL",
        "label": r"B Filter",
    },
}
...
for wgt_ver in (1, 2):
    ...
    for ds in datasets:
        ...
        my_analysis[ds]["truth_weight_lumi1"] = (
            my_analysis[ds]["weight_mc"] * xs * filt_eff * kFactor / sumw
        )
        my_analysis[ds]["truth_weight"] = (
            my_analysis[ds]["weight_mc"] * my_analysis[ds].lumi * xs * filt_eff * kFactor / sumw
        )
        ...
        base_no_filteff.append(
            [
                ...
                filt_eff,
                sumw,
                my_analysis[ds]["base_no_filteff_wtg"].mean(),
                xs,
            ]
        )
        ...
        lumi_1_metadata.append(
            [
                ...
                filt_eff,
                sumw,
                my_analysis[ds]["truth_weight_lumi1"].mean(),
                xs,
            ]
        )
        ...
        reg_metadata.append(
            [
                ...
                filt_eff,
                sumw,
                my_analysis[ds]["truth_weight"].mean(),
                xs,
            ]
        )
