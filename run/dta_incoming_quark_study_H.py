...
if __name__ == "__main__":
    ...
    my_analysis = Analysis(
        ...
        analysis_label="dta_incoming_quark_study_H",
        skip_verify_pkl=False,
        lepton="tau",  # force_rebuild=True,
        dataset_type="dta",
        log_level=10,
        log_out="both",
        force_rebuild=True,
    ...
    my_analysis["wtaunu_h_dta"].plot_dsid(
        "TruthMTW", weight="truth_weight", bins=(30, 1, 5000), logx=True, logy=True, logbins=True
    )

    my_analysis.plot_hist(
        ["wtaunu_CVetoBVeto_dta_h", "wtaunu_CFilterBVeto_dta_h", "wtaunu_BFilter_dta_h"],
        "TruthMTW",
        bins=(30, 1, 5000),
        weight="truth_weight",
    ...
    my_analysis.plot_hist(
        ...
        "TruthTauPt",
        bins=(30, 1, 5000),
        weight="truth_weight",  # ratio_axlim=1.5,
        title="truth - 36.2fb$^{-1}$",
        normalise=False,
        logx=True,
        logbins=True,
