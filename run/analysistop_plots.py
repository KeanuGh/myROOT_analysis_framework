...
my_analysis['wmintaunu_analysistop']['truth_weight'] = my_analysis['wmintaunu_analysistop']['weight_mc'] * \
...
my_analysis['wplustaunu_analysistop']['truth_weight'] = my_analysis['wplustaunu_analysistop']['weight_mc'] * \
